...
```bash
npx degit "sveltejs/sapper-template#rollup" video-chat
```

For a webpack-based project, instead run

```bash
npx degit "sveltejs/sapper-template#webpack" video-chat
```

[`degit`](https://github.com/Rich-Harris/degit) is a scaffolding tool that lets you create a directory from a branch in a repository.

Replace `video-chat` with the path where you wish to create the project.
